...
- run_bash's hardcoded `dangerous` list (5 items) in loop/agent/tools.py
- Hooks.DENY_LIST (7 items) in loop/agent/hooks.py
- Hooks.PERMISSION_RULES (2 rules) in loop/agent/hooks.py
