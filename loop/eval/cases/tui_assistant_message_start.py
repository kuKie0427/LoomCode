...
class AgentLoopAssistantMessageStartInDefaults(EvalCase):
    name = "agent-loop-assistant-message-start-in-defaults"
    description = (
...
class AgentLoopAssistantMessageStartFiresPerLLMCall(EvalCase):
    name = "agent-loop-assistant-message-start-fires-per-llm-call"
    description = (
    ...
    def run(self) -> EvalResult:
        ...
        with patch("loop.agent.loop.configure_logging"), \
             ...
             patch("loop.agent.loop._run_tool_turn",
                   return_value=[
...
class AgentLoopMessageStartStillOncePerInvocation(EvalCase):
    name = "agent-loop-message-start-still-once-per-invocation"
    description = (
