...
class Tier1WithinBudget(EvalCase):
    ...
    def run(self) -> EvalResult:
        ...
        from loop.memory.context import TIER1_TOKEN_BUDGET, load_tier1, token_count
        text = load_tier1(wd)
...
class CombinedTier1Tier2WithinBudget(EvalCase):
    ...
    def run(self) -> EvalResult:
        ...
        from loop.memory.context import COMBINED_BUDGET, combined_tier1_tier2, token_count
...
class CheckpointAtomicSave(EvalCase):
    ...
    def run(self) -> EvalResult:
        ...
        from loop.agent.checkpoint import default_path_for, save
