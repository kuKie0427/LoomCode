...
class SystemPrompt:
    ...
    def add_dynamic(self, section: str) -> None:
        self.dynamic.append(section+"\n")

    def build(self) -> str:
        return "".join(self.static + [BOUNDARY] + self.dynamic)
...
if __name__ == "__main__":
    ...
    sp.add_dynamic(f"工作目录: {WORKDIR1}")
    sp.add_dynamic(sp.get_git_context(WORKDIR1))
