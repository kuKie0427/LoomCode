...
class MemoryQ3OwnProjectTrue(EvalCase):
    ...
    def run(self) -> EvalResult:
        ...
        from loom.memory.paths import is_own_project, memory_file
        mem = memory_file(wd)
...
class MemoryQ3ForeignProjectFalse(EvalCase):
    ...
    def run(self) -> EvalResult:
        ...
        from loom.memory.paths import is_own_project
...
class SkillsProjectOverridesUser(EvalCase):
    ...
    def run(self) -> EvalResult:
        ...
        import loom.skills.discovery as d
        from loom.skills.registry import build_skill_index
